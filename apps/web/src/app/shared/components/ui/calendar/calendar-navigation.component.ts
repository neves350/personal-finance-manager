...
import { ZardSelectComponent } from '@/shared/components/ui/select/select.component'
import { ZardSelectItemComponent } from '@/shared/components/ui/select/select-item.component'
...
export class ZardCalendarNavigationComponent {
	...
	protected readonly isPreviousDisabled = computed(() => {
		...
		const currentMonth = Number.parseInt(this.currentMonth(), 10)
		const currentYear = Number.parseInt(this.currentYear(), 10)
